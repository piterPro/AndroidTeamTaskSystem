...
import com.piter.piterdiplomna.ObjectClasses.CommentClass;
...
//        MyDateHelper halp = new MyDateHelper();
        final String formatedTime=SharedPreferencesManage.getInstance().returnCorrectFormatDate(SharedPreferencesManage.getInstance().convertFromString(holder.getCreate_date_time()));
