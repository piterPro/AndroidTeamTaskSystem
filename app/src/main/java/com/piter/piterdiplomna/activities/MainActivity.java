...
import com.piter.piterdiplomna.fragments.EditInfoFragment;
import com.piter.piterdiplomna.fragments.TaskAddFragment;
import com.piter.piterdiplomna.fragments.CalendarFragment;
import com.piter.piterdiplomna.fragments.ChatUserListFragment;
...
//        intent.putExtra("id",SharedPreferencesManage.getInstance().getUserId()+"");
    ...
    public void SetDateTodayInMilisec() {
        BeginDate=EndDate=System.currentTimeMillis();
        Log.d(TAG, "SetDateTodayInMilisec: in millis"+BeginDate );
    }
